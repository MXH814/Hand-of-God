...
export const LEVEL_01: GameLevel = {
  ...
  blocks: [
    ...
    },
    {
      id: "middle-island",
      kind: "platform",
      position: { x: 1.2, y: 0.18, z: -0.16 },
      size: { x: 1.76, y: 0.36, z: 1.1 },
      rotation: { y: -0.08 },
      color: "#7e8b83",
    },
    {
      id: "goal-feed-ramp",
      kind: "ramp",
      position: { x: 2.2, y: 0.5, z: -0.72 },
      size: { x: 1.22, y: 0.22, z: 0.58 },
      rotation: { y: -0.38, z: -0.16 },
      color: "#87968d",
    },
    {
      id: "goal-terrace",
      kind: "platform",
      position: { x: 3.05, y: 0.23, z: -1.18 },

...
| Segment 2 | 传送区 | Portal A、Portal B、第一道挡门 | 符文触发 | 激活后小球从 Portal A 升起淡出，再从 Portal B 渐显落下，并打开第一道挡门 |
| Segment 3 | 气流控制区 | Air Belt、第二道挡门 | 气流指向手势 | 拇指伸出、食指中指并拢、无名指小指收起，向右指向以开启右风 |

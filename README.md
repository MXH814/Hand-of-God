...
- 第 1 关提供分段机关解谜路线，使用清障、合桥、旋转地台和张掌激活终点等机关。
...
| 双手捏合旋转 | 旋转教学物体、旋转地台 | Unity 计算两只手 pinch center 连线角度变化，将角度增量映射为物体或机关的 Y 轴旋转 |
...
| Segment 3 | 旋转地台区 | 低矮旋转地台、第三道门 | 双手捏合旋转 | 将旋转地台转到道路方向并锁定，让小球从平台上方通过 |
...
- 旋转机关是低矮地台而不是竖直挡板，锁定后保留地面碰撞体，避免小球穿模或下陷。
- 终点复用第 2 关终点祭坛视觉。
- 双手旋转方向与真实手势方向一致。
...
教学物体和旋转地台都使用该角度增量驱动旋转方向，使物体旋转方向与玩家双手旋转方向一致。
